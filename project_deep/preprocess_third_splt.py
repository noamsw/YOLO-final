...
bottles_cups_cans = ["Glass bottle", "Glass jar","Glass cup", "Clear plastic bottle","Other plastic bottle", 
                    "Disposable plastic cup","Other plastic cup", "Paper cup",
                    "Aerosol", "Drink can", "Food Can", 
                    ]


bags = ["Polypropylene bag", "Plastic film","Single-use carrier bag",
            "Garbage bag",]
...
other_plastic = [
            ...
            "Plastic straw","Plastic lid","Spread tub",  "Other plastic", "Other plastic container",]
        
small_waste = ["Cigarette", "Broken glass","Unlabeled litter", "Pop tab",
                "Scrap metal",]
...
other = ["Battery",  "Aluminium foil", 
            "Metal bottle cap", "Food waste","Metal lid",]
# other = ["Battery", "Unlabeled litter", ]
paper = [
            "Corrugated carton", "Egg carton", "Toilet tube",
            "Other carton", "Normal paper", "Paper bag",
            "Tissues", "Paper straw", "Meal carton", "Pizza box",]
# bio = ["Food waste",]
...
def taco_label_to_new_label(label):
    categories = {"bottles_cups_cans":0, "bags":1, "other_plastic":2, "small_waste":3, "non_recyclable":4,
        "paper":5, "other":6}
    if (label in bottles_cups_cans):
        label = "bottles_cups_cans"
    elif (label in bags):
        label = "bags"
